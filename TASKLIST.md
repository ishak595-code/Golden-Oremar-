...
Canlı `public.products` verisinde aktif ürünlerin `short_description` alanları 93–140 karakter aralığında ve incelenen aktif ürünlerin tamamında `short_description`, `description` ile birebir aynı. Bu içerik girişi sorunudur; görev kuralı gereği kod tarafında zorla kısaltılmayacak. Kısa teaser metinleri daha sonra içerik kaynağında ayrıştırılmalıdır.
