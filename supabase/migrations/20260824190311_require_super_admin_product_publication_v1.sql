...
create or replace function private.admin_review_product_v4(
 p_product_id uuid,p_approve boolean,p_reason text,p_ownership_checked boolean,p_image_checked boolean,p_scope_checked boolean,p_origin_checked boolean
)
returns jsonb
language plpgsql
security definer
...
create or replace function private.admin_review_product_change_v3(
 p_change_request_id uuid,p_approve boolean,p_reason text,p_ownership_checked boolean,p_image_checked boolean,p_scope_checked boolean,p_origin_checked boolean
)
returns jsonb
language plpgsql
security definer
