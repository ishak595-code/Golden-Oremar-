...
export default function ProducerFinancePanel({ onBack }: { onBack: () => void }) {
  ...
  return <div className="space-y-5">
    <div className="flex items-center justify-between gap-3"><button type="button" onClick={onBack} className="min-h-11 rounded-xl border-2 border-gray-200 bg-white px-4 font-bold shadow-sm transition-all hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:hover:border-gray-600" aria-label="Satıcı paneline dön"><ArrowLeft aria-hidden="true" className="mr-2 inline h-4 w-4"/>Geri</button><button type="button" onClick={() => void load(true)} disabled={loadingMore || revealingBank || Boolean(payoutBusy)} className="min-h-11 rounded-xl border-2 border-gray-200 bg-white px-4 font-bold shadow-sm transition-all hover:border-gray-300 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none dark:border-gray-700 dark:bg-gray-900 dark:hover:border-gray-600" aria-label="Finans bilgilerini yenile"><RefreshCw aria-hidden="true" className="mr-2 inline h-4 w-4"/>Yenile</button></div>
