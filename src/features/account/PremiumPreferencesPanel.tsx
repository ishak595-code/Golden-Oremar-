...
export default function PremiumPreferencesPanel({theme,onThemeChange,mode='all',onSaved}:Props){
 ...
 return<div className="space-y-3">
  ...
  {status&&!onSaved?<div role="status" aria-live="polite" className="rounded-xl border border-brand-green/20 bg-brand-green/5 p-3 text-sm font-semibold text-brand-green">{status}</div>:null}
 </div>;
}
