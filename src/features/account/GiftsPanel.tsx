...
export default function GiftsPanel({ onStartGift }: { onStartGift?: () => void }) {
  ...
  if(!items)return <Panel title="Hediye Ettiklerim" description="Hediye olarak verdiğiniz gerçek siparişleri, alıcı, ürün ve sipariş durumuyla birlikte izleyin."><ErrorState message={error||'Hediye sipariş listesi doğrulanamadı.'} onRetry={()=>void load()}/></Panel>;
