...
export default function AccountCenter({
 ...
 if(view!=='home')return<div className="space-y-4">
  ...
  <div ref={viewContentRef} tabIndex={-1} className="outline-none">{body()}</div>
 </div>;
 ...
 return<section aria-labelledby="account-title" className="space-y-5">
  ...
  <div className="grid gap-3">
   <div className="grid gap-3 sm:grid-cols-2">
    <button type="button" onClick={onOpenHealth} className="min-h-16 rounded-2xl border border-gray-200 bg-white p-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold dark:border-gray-800 dark:bg-gray-900">
    ...
    <button type="button" onClick={onOpenEvents} className="min-h-16 rounded-2xl border border-gray-200 bg-white p-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold dark:border-gray-800 dark:bg-gray-900">
   ...
   {menu.map(([key,label,Icon,description])=><button type="button" key={key} onClick={()=>{if(key==='contact'){onOpenContact?.();return;} if(key==='orders')setOrderDetailId(''); setView(key as AccountView);}} className="min-h-16 w-full rounded-2xl border border-gray-200 bg-white p-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold dark:border-gray-800 dark:bg-gray-900">
