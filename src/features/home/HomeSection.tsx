...
import{ArrowDownUp,ArrowRight,Calendar,CheckCircle2,Filter,Flame,Search,SlidersHorizontal,Star,Sun}from'lucide-react';
...
export default function HomeSection({searchQuery,setSearchQuery,onProductClick,onAddToCart,onToggleFavorite,favorites,onShare,onGift}:Props){
 const{heroCategories,homeSections,salesReadiness,error:storefrontConfigError}=usePublicStorefrontConfig('tr');
