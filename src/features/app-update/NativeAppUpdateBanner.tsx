...
export default function NativeAppUpdateBanner(){
 ...
 if(!isAndroid||!state?.supported||(!state.available&&!state.inProgress&&!state.downloaded&&!state.downloading))return null;
 ...
 return<section data-native-app-update-banner="true" role="status" aria-live="polite" className="relative z-[90] border-b border-brand-border bg-brand-green px-4 py-2.5 text-brand-on-green shadow-sm">
