...
import{currentProductReference,getProductAvailabilityState,getProductAvailabilitySubscription,setProductAvailabilitySubscription}from'./productAvailabilityApi';
