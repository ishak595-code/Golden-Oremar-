...
export function AdminOrders({ setActiveTab }: { setActiveTab?: (tab: string) => void }) {
  ...
  return <div className="space-y-6">
    ...
    {toast ? <div role="status" aria-live="polite" className="fixed bottom-4 right-4 z-[80] flex max-w-md items-center gap-2 rounded-xl border-2 border-gray-900 bg-gray-900 px-5 py-3 font-bold text-white shadow-2xl"><Check className="h-5 w-5 text-green-400" aria-hidden="true"/>✓ {toast}</div> : null}
  </div>;
}
