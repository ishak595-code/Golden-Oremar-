...
const ADMIN_TABS=new Set(['dashboard','production-readiness','business-compliance','official-store-products','product-health','products','product-approvals','product-removal','orders','returns','stock','shipping-readiness','finance','producer-payouts','payment-controls','transactional-emails','users','account-erasure','role-governance','system-errors','content','settings','categories','vendors','storefronts','reviews','campaigns','notifications','vendor-applications','events','producer-event-submissions']);
