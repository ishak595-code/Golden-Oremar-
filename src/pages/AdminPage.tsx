...
const SuperAdminBulkProductRelease = lazy(() => import('../admin/SuperAdminBulkProductRelease'));
...
export function AdminPage({onLogout,onBack,initialTab}:AdminPageProps){
 ...
 const productsReleased=useCallback(()=>{setProductRefreshKey(value=>value+1);},[]);
