...
expect(homeProductCard.includes('data-product-id={item.id}')&&homeProductCard.includes('data-product-reference={item.slug}')&&homeProductCard.includes('data-product-link="true"'),'Home product rows must retain stable product identity/reference and explicit link markers.');
